...
void experiment()
{
    ...
    std::cout << std::left << std::setw(20) << "Degree" 
              << std::setw(20) << "Search Time (ms)" 
              << std::setw(20) << "Insert Time (ms)" 
              << std::setw(20) << "Delete Time (ms)" << std::endl;
    std::cout << "--------------------------------------------------------------------------" << std::endl;

    for (int d = 0; d < 4; d++)
    {
        int degree = degrees[d];
        BTree tree(degree); // Initialize B-tree with the given degree

        // Prepare random keys
        int *keys = new int[num_operations];
        if (keys == nullptr)
        {
        ...
        std::cout << std::left << std::setw(20) << degree 
                  << std::setw(20) << search_time 
                  << std::setw(20) << insert_time 
                  << std::setw(20) << delete_time << std::endl;
