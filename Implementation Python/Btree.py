...
def display_menu():
    print("B-Tree Operations Menu:")
    print("1. Insert")
    print("2. Search")
    print("3. Delete")
    print("4. Print B-Tree")
    print("5. Exit")

def main():
    t = int(input("Enter the minimum degree of B-Tree: "))
    btree = BTree(t)
    ...
    while True:
        ...
        if choice == '1':
            k = int(input("Enter the key to insert: "))
            btree.insert(k)
        elif choice == '2':
            ...
            x = input("Enter the node to delete from (or leave blank for root): ")
            if x == "":
                x = btree.root
            else:
                x = btree.root
